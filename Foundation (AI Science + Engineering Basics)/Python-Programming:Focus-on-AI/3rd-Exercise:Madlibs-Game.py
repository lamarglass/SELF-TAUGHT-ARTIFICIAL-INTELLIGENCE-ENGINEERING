# 3rd-Exercise: Madlibs-Game

# Madlibs = A game where you create a story by filling in blanks with
#           random words.
...
#######################################################################
name = str(input("Hello there and welcome to this this madlibs program, please share your name: "))

print(f"Nice to meet you {name}, Now lets start the game shall we?")
